        ...
        <div className="mb-4 flex items-center justify-between rounded-xl border border-white/10 bg-black/20 px-3 py-2.5">
          <p className="text-xs cr-text-muted">
            ...
            {activeTab === 'open' && allEntries.length >= OPEN_CAMPAIGNS_SCAN_LIMIT ? (
              <span className="ml-1 text-white/50">(newest {OPEN_CAMPAIGNS_SCAN_LIMIT} live campaigns)</span>
            ) : null}
          </p>
      ...
      {activeTab === 'invites' ? (
        invitations.length === 0 ? (
          <Panel variant="creator" className={CREATOR_CAMPAIGN_EMPTY_CLASS}>
            <p className="py-8 text-center text-sm cr-text-muted">No pending invitations.</p>
          </Panel>
        ) : (
                        ...
                        (() => {
                          ...
                          return (
                            <div className="text-right">
                              ...
                              <p className="text-nx-10 cr-text-muted">creator pool</p>
                            </div>
                          )
                        })()}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="shrink-0 text-right">
                      ...
                      <p className="mt-0.5 text-xs cr-text-muted">{c._count.applications} applied</p>
            ...
            <Panel variant="creator" className={CREATOR_CAMPAIGN_EMPTY_CLASS}>
              <p className="py-8 text-center text-sm cr-text-muted">
                {showAll
                  ...
                  : 'No launched campaigns. Switch to "All accepted" to see campaigns not yet launched.'}
              </p>
            </Panel>
          ) : (
            <ul className="space-y-3.5">
