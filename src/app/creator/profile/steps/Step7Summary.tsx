          ...
          <div className="cr-panel p-3 space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              {steamInitial.steam_id ? (
                <div className="flex-1 min-w-0">
                  <span className="text-xs cr-text-bright truncate block">{steamInitial.username ?? 'Steam User'}</span>
                  <span className="text-[10px] cr-text-muted font-mono">{steamInitial.steam_id}</span>
                </div>
              ) : (
                <span className="text-xs cr-text-muted italic">Not connected</span>
              )}
              {steamInitial.steam_id && (
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-[rgba(102,192,244,0.1)] text-[#66c0f4] border border-[rgba(102,192,244,0.25)] shrink-0">Connected</span>
              )}
            </div>
          </div>
        </div>
