...
//         steam_id: true,
//         steam_username: true,
//         steam_profile_url: true,
//         steam_avatar_url: true,
//         steam_profile_visibility: true,
//         steam_synced_at: true,
//       },
//     }),
//   ])
...
//           }}
//           steamInitial={{
//             steam_id: creator?.steam_id ?? null,
//             username: creator?.steam_username ?? null,
//             profile_url: creator?.steam_profile_url ?? null,
//             avatar_url: creator?.steam_avatar_url ?? null,
//             visibility: creator?.steam_profile_visibility ?? null,
//             synced_at: creator?.steam_synced_at ?? null,
//           }}
//           creatorStats={{
//             twitch_username: creator?.twitch_username ?? null,
//             twitch_broadcaster_type: creator?.twitch_broadcaster_type ?? null,
  ...
  const [profile, creator] = await Promise.all([
    ...
    prisma.content_creators.findUnique({
      ...
      select: {
        ...
        steam_avatar_url: true,
        steam_profile_visibility: true,
        steam_top_games: true,
        steam_recent_games: true,
        steam_synced_at: true,
      },
    }),
  ])
      ...
      <main className="w-full max-w-3xl mx-auto p-6 sm:p-8">
        ...
        <CreatorProfileWizard
          ...
          creatorStats={{
            ...
            youtube_synced_at: creator?.youtube_synced_at ?? null,
            steam_id: creator?.steam_id ?? null,
            steam_username: creator?.steam_username ?? null,
            steam_profile_visibility: creator?.steam_profile_visibility ?? null,
            steam_top_games: creator?.steam_top_games ?? null,
            steam_recent_games: creator?.steam_recent_games ?? null,
