        ...
        <div className="sponsor-creators sponsor-creators-detail mx-auto max-w-5xl space-y-6">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4 rounded-xl border border-white/10 border-l-4 border-l-[#99f7ff]/45 bg-black/20 p-4 sm:p-5">
            <div className="min-w-0">
              ...
              <p className="cr-field-label">Creator</p>
          ...
          <div className="grid gap-5 lg:grid-cols-12">
            <div className="space-y-5 lg:col-span-8">
              ...
              >
                <h2 className="cr-panel-title">Creator profile</h2>
                    ...
                    <Field
                      ...
                      value={
                        creator.steam_id ? (
                          ...
                          <span className="cr-text-muted">Not connected</span>
                        )
                      }
                    />
                  </div>
            ...
            <div className="space-y-4 lg:col-span-4 lg:sticky lg:top-24 lg:self-start">
              <NxHudCard as="div" className="sp-app-stat-panel rounded-xl p-4">
                <h3 className="cr-panel-title">Performance</h3>
                <dl className="mt-3 space-y-2.5">
                  <SideRow label="Twitch followers">{formatNum(creator.subs_followers)}</SideRow>
                  <SideRow label="YouTube subscribers">{formatNum(creator.youtube_subscribers)}</SideRow>
                  <SideRow label="Avg views">{formatNum(avgViews)}</SideRow>
                  <SideRow label="Engagement">
              ...
              <NxHudCard as="div" className="sp-app-stat-panel rounded-xl p-4">
                ...
                <dl className="mt-3 space-y-3">
                  ...
                  <div>
                    <p className="sp-app-stat-label mb-1.5">Interests</p>
                    <div className="flex flex-wrap gap-1">
