...
export default async function HomePage() {
  ...
  const dashboardLabel =
    role === 'admin' ? t('roles.adminDashboard') :
    role === 'creator' ? t('roles.creatorDashboard') :
    role === 'sponsor' ? t('roles.sponsorDashboard') :
    null
    ...
    <>
      ...
      <div className="home-root">
        <div className="home-topbar">
          ...
          <SignOutButton>
            <button type="button" className="home-sign-out">{t('signOut')}</button>
          </SignOutButton>          
        </div>
        </div>

        <div className="home-body">
          <div className="home-greeting">{t('greeting', { username })}</div>
          ...
          {dashboardLink && (
            <div className="home-cta">
              <Link href={dashboardLink} className="home-dashboard-btn">
                ...
                {t('goToDashboard', { label: dashboardLabel ?? '' })}
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path d="M3 7h8M7 3l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </Link>
              <span className="home-btn-label">{t('primaryWorkspace')}</span>
            </div>
          )}

          {/* Quick links based on role */}
          <div className="home-section-label">{t('quickAccess')}</div>
          ...
          <div className="home-grid">
            ...
            {(role === 'creator' || role === 'admin') && (
              <>
                ...
                <HomeQuickAccessCard
                  ...
                  description={t('cards.profileDesc')}
                  icon={
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            {(role === 'sponsor' || role === 'admin') && (
              <>
                <HomeQuickAccessCard
                  ...
                  title={t('cards.myCampaigns')}
                  description={t('cards.myCampaignsDesc')}
                  icon={
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <HomeQuickAccessCard
                  ...
                  title={t('cards.browseCreators')}
                  description={t('cards.browseCreatorsDesc')}
                  icon={
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            {role === 'admin' && (
              <>
                <HomeQuickAccessCard
                  href="/admin/creators"
                  title={t('cards.manageCreators')}
                  description={t('cards.manageCreatorsDesc')}
                  icon={
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <HomeQuickAccessCard
                  ...
                  description={t('cards.reportsDesc')}
                  icon={
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <HomeQuickAccessCard
              ...
              description={t('cards.settingsDesc')}
              icon={
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
