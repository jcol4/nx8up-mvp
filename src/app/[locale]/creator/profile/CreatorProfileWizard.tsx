      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-base font-semibold cr-text-bright">
            {t('wizardStepHeading', { n: step, label: stepLabels[step - 1] })}
          </h2>
          <p className="text-xs cr-text-muted mt-0.5">{t('wizardProgress', { n: step, total: TOTAL_STEPS })}</p>
        </div>
      </div>
