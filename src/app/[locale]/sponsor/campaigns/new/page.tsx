              ...
              <div className="relative px-6 pt-6 pb-5">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="min-w-0 pt-0.5">
                    <h1 className="text-lg font-semibold tracking-tight text-[#e8f4ff]">{t('newProfileTitle')}</h1>
      ...
      <div className="flex-1 p-6 sm:p-8 overflow-auto">
        <div className="max-w-3xl mx-auto">
          <div className="mb-6 rounded-xl border border-white/10 bg-black/20 p-4">
            <p className="font-headline text-nx-11 uppercase tracking-[0.2em] text-[#99f7ff]">{t('newHeading')}</p>
            <h1 className="mt-1 font-headline text-xl font-semibold text-[#e8f4ff]">{t('newTitle')}</h1>
