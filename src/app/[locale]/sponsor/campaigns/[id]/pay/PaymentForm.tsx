...
function CheckoutForm({
  ...
  const t = useTranslations('sponsor.pay')
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {largeBudget ? (
          <div className="flex items-start gap-2 mb-4 p-3 rounded-lg border border-[#00c8ff]/30 bg-[#00c8ff]/5">
            ...
            <p className="text-xs text-[#00c8ff] leading-relaxed">
              <span className="font-semibold">{t('largeBudgetTitle')}</span> {t('largeBudgetDesc')}
            </p>
          </div>
        ) : (
          <div className="flex items-start gap-2 mb-4 p-3 rounded-lg border border-red-500/30 bg-red-500/5">
            ...
            <p className="text-xs text-red-400 leading-relaxed">
              <span className="font-semibold">{t('headsUp')}</span> {t('achDesc')}
            </p>
          </div>
        )}
        <PaymentElement
      ...
      >
        {processing ? t('processing') : t('payButton', { budget: budgetDisplay })}
      </button>
