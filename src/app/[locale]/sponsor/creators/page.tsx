        ...
        <div className="sponsor-creators sponsor-creators-detail mx-auto max-w-5xl space-y-6">
          <div className="flex flex-wrap items-end justify-between gap-4 rounded-xl border border-white/10 border-l-4 border-l-[#99f7ff]/45 bg-black/20 p-4 sm:p-5">
            <div className="min-w-0">
              <p className="cr-field-label">{t('directory')}</p>
            ...
            <div className="sp-app-header-stat shrink-0 rounded-lg px-4 py-2.5 text-center">
              ...
              <p className="sp-app-stat-label mt-0.5">
                {t('creatorCount', { n: ranked.length })}
              </p>
            </div>
          </div>

          <div className="rounded-xl border border-white/10 bg-black/25 p-4">
            <p className="sp-app-stat-label mb-3">{t('filters')}</p>
              ...
              <table className="sp-creators-table w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="px-4 py-3 text-left">{t('thPlatforms')}</th>
                    <th className="px-4 py-3 text-right">{t('thFollowers')}</th>
                    <th className="px-4 py-3 text-right">{t('thAvgViews')}</th>
                    <th className="px-4 py-3 text-right">{t('thCtr')}</th>
                    <th className="px-4 py-3 text-left">{t('thContent')}</th>
                    <th className="px-4 py-3 text-left">{t('thSize')}</th>
                  </tr>
                </thead>
                <tbody>
                  {ranked.map((c, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        >
                          {c.handle ?? <span className="italic cr-stat-caption">{t('noHandle')}</span>}
                        </Link>
                        {c.location && (
                      ...
                      <td className="px-4 py-3">
                        <div className="flex flex-wrap gap-1">
                          {c.content_type.slice(0, 2).map(ct => (
                            <span
                              key={ct}
